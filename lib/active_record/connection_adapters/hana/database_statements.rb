    ...
    module Hana
      module DatabaseStatements
        ...
        def set_isolation_level(isolation_level)
          fail ArgumentError, "Invalid isolation level, #{isolation_level}. Supported levels include #{valid_isolation_levels.to_sentence}." unless valid_isolation_levels.include?(isolation_level.upcase)
